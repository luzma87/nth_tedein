...
<html>
    ...
    <body>
        ...
        <ul class="topnav ui-corner-all" style="position:absolute; top:2px;z-index:1999;">
            ...
            <li title="Guardar el dise&ntilde;o actual"><a href="#" id="guardarLayout">Guardar diseño</a></li>
            ...
            <li title="Tipo de layout" style="z-index:9999">
                <a href="#" id="tipo">Tipo</a>
                <ul class="subnav">
                    <li>
                        <a href="#" tool="Paginas web completas" tipo="1" class="tipoPagina">Página</a>
                    </li>
                    <g:each in="${tiposPagina}" var="tipo">
                        <li>
                            <a href="#" tool="${tipo.descripcion}" tipo="${tipo.id}" class="tipoPagina">${tipo.nombre}</a>
                        </li>
                    </g:each>
                </ul>
            </li>

            <li title="Eliminar el dise&ntilde;o actual"><a href="#" id="borrarLayout">Borrar Diseño</a></li>

            <li title="Reiniciar al dise&ntilde;o por defecto"><a href="#" id="reset">Reset</a></li>

            <li title="Editar las propiedades del layout"><a href="#" id="propiedades">Propiedades</a></li>
        ...
        <div id="divBody" style="position:relative;width:100%;height:90%;margin-top:40px;overflow:auto;${layout?.css}">
            ...
            <g:if test="${layout}">
                <g:if test="${layout.idioma != null}">
                    <div class="drag" id="idioma"
                         style="position:absolute;z-index:2;top:${(layout?.idioma?.top > -1) ? layout?.idioma?.top : "524px"};left:${(layout?.idioma?.izq > -1) ? layout?.idioma?.izq : "200px"};width:${(layout?.idioma?.width) ? layout?.idioma?.width : "400px"};height:${(layout?.idioma?.height) ? layout?.idioma?.height : "35px"}; ${(layout?.idioma?.css) ? (layout?.idioma?.css?.contains("border") || layout?.idioma?.css?.contains("background") ? layout?.idioma?.css : layout?.idioma?.css + "border:1px #00ff99 solid;cursor:move;background:rgba(0,200,0,0.3);") : "border:1px #00ff99 solid;cursor:move;background:rgba(0,200,0,0.3);"}">
                        <elm:barrita title="Idioma" botones="${['eliminar', 'editar', 'propiedades']}" float="right"
                                     id="idioma" param="seccion='idioma'"/>
                        <div id="idiomaContenido">
                            <g:mostrarIdiomas tipo="editor" layout="${layout?.id}"/>
                        </div>
                    </div>
                </g:if>
            </g:if>
            <g:else>
                <div class="drag" id="idioma"
                     style="position:absolute;z-index:2;top:${(layout?.idioma?.top > -1) ? layout?.idioma?.top : "524px"};left:${(layout?.idioma?.izq > -1) ? layout?.idioma?.izq : "200px"};width:${(layout?.idioma?.width) ? layout?.idioma?.width : "400px"};height:${(layout?.idioma?.height) ? layout?.idioma?.height : "35px"}; ${(layout?.idioma?.css) ? layout?.idioma?.css : "border:1px #00ff99 solid;cursor:move;background:rgba(0,200,0,0.3);"};">
                    <elm:barrita title="Idioma" botones="${['eliminar', 'editar', 'propiedades']}" float="right" id="idioma"
                                 param="seccion='idioma'"/>
                    <div id="idiomaContenido">
                    </div>
                </div>
            </g:else>
            ...
            <g:if test="${layout}">
                <g:if test="${layout.banner != null}">
                    <div class="drag" seccion="${layout?.banner?.id}" id="banner"
                         style="position:absolute;z-index:1;top:${(layout?.banner?.top > -1) ? layout?.banner?.top : "5px"};left:${(layout?.banner?.izq > -1) ? layout?.banner?.izq : "200px"};width:${(layout?.banner?.width) ? layout?.banner?.width : "400px"};height:${(layout?.banner?.height) ? layout?.banner?.height : "60px"}; ${(layout?.banner?.css) ? (layout?.banner?.css.contains("border") ? layout?.banner?.css+";cursor:move;" : layout?.banner?.css+";border:1px #0099ff solid;cursor:move;" ) : "border:1px #0099ff solid;cursor:move;background:rgba(0,0,200,0.3);"};">
        ...
        %{--<g:if test="${layout.idioma!=null}">--}%
        %{--<div class="drag" id="idioma"--}%
        %{--style="position:absolute;z-index:2;top:${(layout?.idioma?.top > -1) ? layout?.idioma?.top : "70px"};left:${(layout?.idioma?.izq > -1) ? layout?.idioma?.izq : "200px"};width:${(layout?.idioma?.width) ? layout?.idioma?.width : "400px"};height:${(layout?.idioma?.height) ? layout?.idioma?.height : "40px"}; ${(layout?.idioma?.css) ? layout?.idioma?.css : "border:1px #8BBA94 solid;cursor:move;background:rgba(152,206,162,0.3);"};">--}%
        %{--<elm:barrita title="Idiomas" botones="${['eliminar','editar', 'propiedades']}" float="right"--}%
        %{--id="idioma" param="seccion='idioma'"/>--}%
        %{--<div id="idiomaContenido"></div>--}%
        %{--</div>--}%
        %{--</g:if>--}%
        %{--</g:if>--}%
        %{--<g:else>--}%
        %{--<div class="drag" id="idioma"--}%
        %{--style="position:absolute;z-index:2;top:${(layout?.idioma?.top > -1) ? layout?.idioma?.top : "70px"};left:${(layout?.idioma?.izq > -1) ? layout?.idioma?.izq : "200px"};width:${(layout?.idioma?.width) ? layout?.idioma?.width : "400px"};height:${(layout?.idioma?.height) ? layout?.idioma?.height : "40px"}; ${(layout?.idioma?.css) ? layout?.idioma?.css : "border:1px #8BBA94 solid;cursor:move;background:rgba(152,206,162,0.3);"};">--}%
        %{--<elm:barrita title="Idiomas" botones="${['eliminar','editar', 'propiedades']}" float="right" id="idioma"--}%
        %{--param="seccion='idioma'"/>--}%
        %{--<div id="idiomaContenido"></div>--}%
        %{--</div>--}%
        %{--</g:else>--}%
            ...
            <g:if test="${layout}">
                <g:if test="${layout.menu != null}">
                    <div class="drag" id="menu"
                         style="position:absolute;z-index:2;top:${(layout?.menu?.top > -1) ? layout?.menu?.top : "70px"};left:${(layout?.menu?.izq > -1) ? layout?.menu?.izq : "200px"};width:${(layout?.menu?.width) ? layout?.menu?.width : "400px"};height:${(layout?.menu?.height) ? layout?.menu?.height : "40px"}; ${(layout?.menu?.css) ? (layout?.menu?.css?.contains("border") || layout?.menu?.css?.contains("background") ? layout?.menu?.css : layout?.menu?.css + "border:1px #ff9999 solid;cursor:move;background:rgba(200,0,0,0.3);") : "border:1px #ff9999 solid;cursor:move;background:rgba(200,0,0,0.3);"}">
            ...
            <g:else>
                <div class="drag" id="menu"
                     style="position:absolute;z-index:2;top:${(layout?.menu?.top > -1) ? layout?.menu?.top : "70px"};left:${(layout?.menu?.izq > -1) ? layout?.menu?.izq : "200px"};width:${(layout?.menu?.width) ? layout?.menu?.width : "400px"};height:${(layout?.menu?.height) ? layout?.menu?.height : "40px"}; ${(layout?.menu?.css) ? layout?.menu?.css : "border:solid 1px #ff9999;cursor:move;background:rgba(200,0,0,0.3);"};">
            ...
            <div class="drag " id="contenido"
                 style="position:absolute;z-index:3;top:${(layout?.contenido?.top > -1) ? layout?.contenido?.top : "120px"};left:${(layout?.contenido?.izq > -1) ? layout?.contenido?.izq : "200px"};width:${(layout?.contenido?.width) ? layout?.contenido?.width : "400px"};height:${(layout?.contenido?.height) ? layout?.contenido?.height : "400px"}; ${(layout?.contenido?.css) ? (layout?.contenido?.css?.contains("border") ? layout?.contenido?.css : layout?.contenido?.css + "border:1px #cccccc solid;cursor:move;background:rgba(204,204,204,0.3);") : "border:1px #cccccc solid;cursor:move;background:rgba(204,204,204,0.3);"};">
        ...
        <div id="ventanaPagina" style="display:none">
            <g:form class="formLayout" action="guardarPagina" controller="editor" enctype="multipart/form-data">
                ...
                <input type="hidden" name="idioma.top" id="itop" value="${(layout?.idioma?.top) ? layout?.idioma?.top : "524"}">
                <input type="hidden" name="idioma.izq" id="iizq" value="${(layout?.idioma?.izq) ? layout?.idioma?.izq : "200"}">
                <input type="hidden" name="idioma.width" id="iwid" value="${(layout?.idioma?.width) ? layout?.idioma?.width : "400"}">
                <input type="hidden" name="idioma.height" id="ihei"
                       value="${(layout?.idioma?.height) ? layout?.idioma?.height : "35"}">
                <input type="hidden" name="idioma.css" id="icss" value="${(layout?.idioma?.css) ? layout?.idioma?.css : ""}">
                <input type="hidden" name="idioma.tipo" value="Layout">
                ...
                <g:if test="${layout}">
                    ...
                    <input type="hidden" name="layout.idioma" id="layIdioma" value="${(layout?.idioma != null) ? '1' : '0'}">
                ...
                <g:else>
                    ...
                    <input type="hidden" name="layout.idioma" id="layIdioma" value="1">
        ...
        <script type="text/javascript">
            ...
            $(".delete").click(function () {
                if (confirm("Esta accion no puede ser revertida...Continuar?")) {
                    ...
                    if ($(this).parent().attr("seccion") == "idioma") {
                        $("#layIdioma").val("0")
                    }
            ...
            $(".contenido").click(function () {
                ...
                if ($("#layout").val() != "") {
                    ...
                    else if ($(this).parent().attr("seccion") == "idioma") {
                        var url = '${g.createLink(controller: "idioma", action:"config")}?id=' + $("#layout").val()
                        child = window.open(url, 'NTH', 'left=0,top=0,width=850,height=715,toolbar=0,resizable=0,menubar=0,scrollbars=1,status=0');
                        if (child.opener == null) child.opener = self;
                        window.toolbar.visible = false;
                        window.menubar.visible = false;
                ...
                if (confirm("Esta seguro? esta acción es irreversible ")) {
                    $.ajax({
                        ...
                        success:function (msg) {
                            ...
                            if (msg == "ok") {
                                $("#btn_pag_${layout?.id}", window.parent.document).remove();
            ...
            function registrarPosicion() {
                ...
                if ($("#layIdioma").val() != "0") {
                    position = $("#idioma").position()
                    $("#itop").val(position.top)
                    $("#iizq").val(position.left)
                    if ($("#vpSeccion").val() == "idioma") {
                        $("#Vtop").val(position.top)
                        $("#Vleft").val(position.left)
                    }
                }
            ...
            function registrarTam() {
                ...
                if ($("#layIdioma").val() != "0") {
                    $("#iwid").val($("#idioma").width())
                    $("#ihei").val($("#idioma").height())
                    if ($("#vpSeccion").val() == "menu") {
                        $("#Vwidth").val($("#menu").width())
                        $("#Vheight").val($("#menu").height())
                    }
                ...
                $(this).parent().parent().prev().find(".propiedad:visible").each(function () {
                    if ($(this).attr("nombre") != "top" && $(this).attr("nombre") != "left" && $(this).attr("nombre") != "width" && $(this).attr("nombre") != "height" && $(this).attr("nombre") != "background" && $(this).attr("nombre") != "background-alpha") {
                        if ($(this).val() != "" && $(this).val() != "0" && $(this).val() != "-1") {
                            ...
                            $("#" + $("#vpSeccion").val().charAt(0) + "css").val($("#" + $("#vpSeccion").val().charAt(0) + "css").val() + ";" + $(this).attr("nombre") + ":" + $(this).val() + sufijo);
                        }
                    } else {
