                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="imagen" title="${message(code: 'idioma.imagen.label', default: 'Imagen')}" />
                        
                            <g:sortableColumn property="abreviacion" title="${message(code: 'idioma.abreviacion.label', default: 'Abreviacion')}" />
                    ...
                    <g:each in="${idiomaInstanceList}" status="i" var="idiomaInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
                                <ig:img src="${createLink(controller:'idioma', action:'showImage', id: idiomaInstance.id)}" alt="${idiomaInstance.nombre}" title="${idiomaInstance.nombre}" />
                            </td>
                        
                            <td>${fieldValue(bean: idiomaInstance, field: "abreviacion")}</td>
