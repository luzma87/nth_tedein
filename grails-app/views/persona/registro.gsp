...
<html>
    ...
    <body>
        ...
        <g:form controller="persona" action="save" name="frmRegistro">
            <div class="cuadro etiqueta-container ui-corner-all">
                <div class="etiqueta-svt ui-corner-right ">Registro</div>

                <div class="mensaje">
                    Por favor complete los datos en el siguiente formulario y nos pondremos en contacto con usted para
                    coordinar el pago del curso.
                </div>
                ...
                <div class="row">
                    ...
                    <div class="field required">
                        <g:select name="curso.id" value="${personaInstance.curso?.id}" optionKey="id" optionValue="nombre"
                                  from="${nth.externos.Curso.list([sort: 'nombre'])}" class="ui-corner-all required"
                                  style="width:187px;"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="field required">
                        <g:textField name="nombre" value="${personaInstance.nombre}" class="ui-corner-all required"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="field required">
                        <g:textField name="apellido" value="${personaInstance.apellido}" class="ui-corner-all required"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="field required">
                        <g:textField name="email" value="${personaInstance.email}" class="ui-corner-all required email"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="field ">
                        <g:textField name="celular" value="${personaInstance.celular}" class="ui-corner-all celular"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="field ">
                        <g:textField name="telefono" value="${personaInstance.telefono}" class="ui-corner-all telefono"/>
                    </div>
                </div>

                <div class="row">
                    <div class="label">
                        Comentarios<br/>Preguntas
                    </div>

                    <div class="field">
                        <g:textArea cols="45" rows="10" name="comentario" value="${personaInstance.comentario}" class="ui-corner-all"/>
                    </div>
                </div>

                <div class="row" style="text-align: center; height: 60px;">
                    <a href="#" class="boton ui-corner-all" id="btnGuardar">Guardar</a>
                </div>
            </div>
        </g:form>
