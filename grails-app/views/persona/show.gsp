            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="persona.celular.label" default="Celular" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: personaInstance, field: "celular")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="persona.comentario.label" default="Comentario" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: personaInstance, field: "comentario")}</td>
