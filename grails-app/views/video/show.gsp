            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="video.frases.label" default="Frases" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="video.galeria.label" default="Galeria" /></td>
                            
                            <td valign="top" class="value"><g:link controller="galeria" action="show" id="${videoInstance?.galeria?.id}">${videoInstance?.galeria?.encodeAsHTML()}</g:link></td>
