 ...
 */
    def show = {attrs, body ->
        ...
        Galeria gallery = (attrs['galleryInstance'])
        ...
        String imgValues = ''
        if (gallery) {
            gallery.images.each {Foto image ->
...
//        println "attrs " + attrs
        ...
        if (attrs['thumbnail']) {
            ...
            out << "<a class='linkFotoLight' href='#' src='${thumbnailSrc}&iframe=true&width=100%&height=100%' title='${title}'>${image}</a>"
        } else {
            out << image
        }
    }
