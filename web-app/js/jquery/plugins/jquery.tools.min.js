 ...
 */
(function(a) {
    a.tools = a.tools || {version:"@VERSION"},a.tools.tabs = {conf:{tabs:"a",current:"current",onBeforeClick:null,onClick:null,effect:"default",initialIndex:0,event:"click",rotate:!1,history:!1},addEffect:function(a, c) {
        b[a] = c
    }};
    ...
    a.tools = a.tools || {version:"@VERSION"},a.tools.scrollable = {conf:{activeClass:"active",circular:!1,clonedClass:"cloned",disabledClass:"disabled",easing:"swing",initialIndex:0,item:null,items:".items",keyboard:!0,mousewheel:!1,next:".next",prev:".prev",speed:400,vertical:!1,touch:!0,wheelSpeed:0}};
    function b(a, b) {
    ...
    a.tools = a.tools || {version:"@VERSION"},a.tools.overlay = {addEffect:function(a, b, d) {
        c[a] = [b,d]
    ...
    function n(c, g) {
        ...
        g.trigger && (r = a("<a/>").attr("href", "#").addClass(n.trigger).click(
                function(a) {
                    h.show();
                    return a.preventDefault()
                }).insertAfter(c));
        ...
        a.extend(h, {show:function(d) {
            if (!(c.attr("readonly") || c.attr("disabled") || A)) {
                ...
                var e = c.offset();
                /iPad/i.test(navigator.userAgent) && (e.top -= a(window).scrollTop()),p.css({top:e.top + c.outerHeight({margins:!0}) + g.offset[0],left:e.left + g.offset[1]}),g.speed ? p.show(g.speed, function() {
                    J(d)
                }) : (p.show(),J(d));
                return h
            }
    ...
    function l(b, c, e) {
        ...
        a.extend(f, {getConf:function() {
            ...
            c = c || b,c.removeClass(e.errorClass).each(
                    function() {
                        var b = a(this).data("msg.el");
    ...
    var h = f(window.flashembed, {conf:e,getVersion:function() {
        ...
        switch (b) {case"string":a = a.replace(new RegExp("([\"\\\\])", "g"), "\\$1"),a = a.replace(/^\s?(\d+\.?\d+)%/, "$1pct");return"\"" + a + "\"";case"array":return"[" + g(a,
                function(a) {
                    return h.asString(a)
                }).join(",") + "]";case"function":return"\"function()\"";case"object":var c = [];for (var d in a)a.hasOwnProperty(d) && c.push("\"" + d + "\":" + h.asString(a[d]));return"{" + c.join(",") + "}"
        }
    ...
    c && (jQuery.tools = jQuery.tools || {version:"@VERSION"},jQuery.tools.flashembed = {conf:e},jQuery.fn.flashembed = function(a, b) {
        return this.each(function() {
    ...
    var b,c,d,e;
    a.tools = a.tools || {version:"@VERSION"},a.tools.history = {init:function(g) {
    ...
    function c(b) {
        switch (b.type) {case"mousemove":return a.extend(b.data, {clientX:b.clientX,clientY:b.clientY,pageX:b.pageX,pageY:b.pageY});case"DOMMouseScroll":a.extend(b, b.data),b.delta = -b.detail / 3;break;case"mousewheel":b.delta = b.wheelDelta / 120
        }
        b.type = "wheel";
